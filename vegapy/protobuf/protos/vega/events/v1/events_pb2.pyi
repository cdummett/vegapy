...
class ProtocolUpgradeProposalStatus(
    ...
    PROTOCOL_UPGRADE_PROPOSAL_STATUS_PENDING: _ClassVar[
        ProtocolUpgradeProposalStatus
    ]
    PROTOCOL_UPGRADE_PROPOSAL_STATUS_APPROVED: _ClassVar[
        ProtocolUpgradeProposalStatus
    ]
    PROTOCOL_UPGRADE_PROPOSAL_STATUS_REJECTED: _ClassVar[
        ProtocolUpgradeProposalStatus
    ]
...
class AMM(_message.Message):
    ...
    class StatusReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        STATUS_REASON_PARTY_ALREADY_OWNS_AMM_FOR_MARKET: _ClassVar[
            AMM.StatusReason
        ]
...
class VolumeDiscountStatsUpdated(_message.Message):
    ...
    def __init__(
        ...
        stats: _Optional[
            _Iterable[_Union[PartyVolumeDiscountStats, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class FeesStats(_message.Message):
    ...
    asset: str
    epoch_seq: int
    total_rewards_received: _containers.RepeatedCompositeFieldContainer[
        PartyAmount
    ]
    referrer_rewards_generated: _containers.RepeatedCompositeFieldContainer[
        ReferrerRewardsGenerated
    ]
    referees_discount_applied: _containers.RepeatedCompositeFieldContainer[
        PartyAmount
    ]
    volume_discount_applied: _containers.RepeatedCompositeFieldContainer[
        PartyAmount
    ]
    total_maker_fees_received: _containers.RepeatedCompositeFieldContainer[
        PartyAmount
    ]
...
class FundingPeriodDataPoint(_message.Message):
    ...
    def __init__(
        ...
        market_id: _Optional[str] = ...,
        seq: _Optional[int] = ...,
        data_point_type: _Optional[
            _Union[FundingPeriodDataPoint.Source, str]
        ] = ...,
        price: _Optional[str] = ...,
...
class Transfer(_message.Message):
    ...
    def __init__(
        ...
        one_off_governance: _Optional[
            _Union[OneOffGovernanceTransfer, _Mapping]
        ] = ...,
...
class TransactionResult(_message.Message):
    ...
    def __init__(
        ...
        ethereum_key_rotate_submission: _Optional[
            _Union[
                _validator_commands_pb2.EthereumKeyRotateSubmission, _Mapping
            ]
        ] = ...,
        ...
        success: _Optional[
            _Union[TransactionResult.SuccessDetails, _Mapping]
        ] = ...,
        failure: _Optional[
            _Union[TransactionResult.FailureDetails, _Mapping]
        ] = ...,
    ) -> None: ...
...
class SettlePosition(_message.Message):
    ...
    party_id: str
    price: str
    trade_settlements: _containers.RepeatedCompositeFieldContainer[
        TradeSettlement
    ]
    position_factor: str
    def __init__(
...
class AuctionEvent(_message.Message):
    ...
    def __init__(
        ...
        extension_trigger: _Optional[
            _Union[_vega_pb2.AuctionTrigger, str]
        ] = ...,
    ) -> None: ...
...
class ReferralSetStatsUpdated(_message.Message):
    ...
    def __init__(
        ...
        referees_stats: _Optional[
            _Iterable[_Union[RefereeStats, _Mapping]]
        ] = ...,
...
class PaidLiquidityFeesStats(_message.Message):
    ...
    epoch_seq: int
    total_fees_paid: str
    fees_paid_per_party: _containers.RepeatedCompositeFieldContainer[
        PartyAmount
    ]
    def __init__(
        self,
...
class PartyProfileUpdated(_message.Message):
    ...
    def __init__(
        self,
        updated_profile: _Optional[
            _Union[_vega_pb2.PartyProfile, _Mapping]
        ] = ...,
    ) -> None: ...
...
class TeamStats(_message.Message):
    ...
    def __init__(
        self,
        team_id: _Optional[str] = ...,
        members_stats: _Optional[
            _Iterable[_Union[TeamMemberStats, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class GameScores(_message.Message):
    ...
    def __init__(
        ...
        team_scores: _Optional[
            _Iterable[_Union[GameTeamScore, _Mapping]]
        ] = ...,
        party_scores: _Optional[
            _Iterable[_Union[GamePartyScore, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class BusEvent(_message.Message):
    ...
    def __init__(
        ...
        position_resolution: _Optional[
            _Union[PositionResolution, _Mapping]
        ] = ...,
        ...
        loss_socialization: _Optional[
            _Union[LossSocialization, _Mapping]
        ] = ...,
        ...
        delegation_balance: _Optional[
            _Union[DelegationBalanceEvent, _Mapping]
        ] = ...,
        validator_score: _Optional[
            _Union[ValidatorScoreEvent, _Mapping]
        ] = ...,
        ...
        network_limits: _Optional[
            _Union[_vega_pb2.NetworkLimits, _Mapping]
        ] = ...,
        transfer: _Optional[_Union[Transfer, _Mapping]] = ...,
        ranking_event: _Optional[
            _Union[ValidatorRankingEvent, _Mapping]
        ] = ...,
        ...
        position_state_event: _Optional[
            _Union[PositionStateEvent, _Mapping]
        ] = ...,
        ethereum_key_rotation: _Optional[
            _Union[EthereumKeyRotation, _Mapping]
        ] = ...,
        protocol_upgrade_event: _Optional[
            _Union[ProtocolUpgradeEvent, _Mapping]
        ] = ...,
        ...
        transaction_result: _Optional[
            _Union[TransactionResult, _Mapping]
        ] = ...,
        core_snapshot_event: _Optional[
            _Union[CoreSnapshotData, _Mapping]
        ] = ...,
        ...
        distressed_positions: _Optional[
            _Union[DistressedPositions, _Mapping]
        ] = ...,
        ...
        referee_switched_team: _Optional[
            _Union[RefereeSwitchedTeam, _Mapping]
        ] = ...,
        referee_joined_team: _Optional[
            _Union[RefereeJoinedTeam, _Mapping]
        ] = ...,
        ...
        referral_program_ended: _Optional[
            _Union[ReferralProgramEnded, _Mapping]
        ] = ...,
        referral_set_created: _Optional[
            _Union[ReferralSetCreated, _Mapping]
        ] = ...,
        referee_joined_referral_set: _Optional[
            _Union[RefereeJoinedReferralSet, _Mapping]
        ] = ...,
        party_activity_streak: _Optional[
            _Union[PartyActivityStreak, _Mapping]
        ] = ...,
        ...
        vesting_stats_updated: _Optional[
            _Union[VestingStatsUpdated, _Mapping]
        ] = ...,
        ...
        transfer_fees_discount: _Optional[
            _Union[TransferFeesDiscount, _Mapping]
        ] = ...,
        party_margin_mode_updated: _Optional[
            _Union[PartyMarginModeUpdated, _Mapping]
        ] = ...,
        party_profile_updated: _Optional[
            _Union[PartyProfileUpdated, _Mapping]
        ] = ...,
