...
class DataSourceDefinition(_message.Message):
    ...
    def __init__(
        self,
        internal: _Optional[
            _Union[DataSourceDefinitionInternal, _Mapping]
        ] = ...,
        external: _Optional[
            _Union[DataSourceDefinitionExternal, _Mapping]
        ] = ...,
    ) -> None: ...
...
class SpecBindingForCompositePrice(_message.Message):
    ...
    def __init__(
        self, price_source_property: _Optional[str] = ...
    ) -> None: ...
...
class DataSourceSpecConfigurationTime(_message.Message):
    ...
    def __init__(
        ...
        conditions: _Optional[
            _Iterable[_Union[_spec_pb2.Condition, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class DataSourceDefinitionInternal(_message.Message):
    ...
    def __init__(
        self,
        time: _Optional[
            _Union[DataSourceSpecConfigurationTime, _Mapping]
        ] = ...,
...
class DataSourceSpecConfiguration(_message.Message):
    ...
    def __init__(
        ...
        filters: _Optional[
            _Iterable[_Union[_spec_pb2.Filter, _Mapping]]
        ] = ...,
    ) -> None: ...
