...
class NodeSignatureKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    NODE_SIGNATURE_KIND_ERC20_MULTISIG_SIGNER_ADDED: _ClassVar[
        NodeSignatureKind
    ]
    NODE_SIGNATURE_KIND_ERC20_MULTISIG_SIGNER_REMOVED: _ClassVar[
        NodeSignatureKind
    ]
...
class ValidatorHeartbeat(_message.Message):
    ...
    def __init__(
        ...
        ethereum_signature: _Optional[
            _Union[_signature_pb2.Signature, _Mapping]
        ] = ...,
        vega_signature: _Optional[
            _Union[_signature_pb2.Signature, _Mapping]
        ] = ...,
...
class ChainEvent(_message.Message):
    ...
    def __init__(
        ...
        nonce: _Optional[int] = ...,
        builtin: _Optional[
            _Union[_chain_events_pb2.BuiltinAssetEvent, _Mapping]
        ] = ...,
...
class StateVariableProposal(_message.Message):
    ...
    def __init__(
        self,
        proposal: _Optional[
            _Union[_vega_pb2.StateValueProposal, _Mapping]
        ] = ...,
    ) -> None: ...
