...
class BatchMarketInstructions(_message.Message):
    ...
    cancellations: _containers.RepeatedCompositeFieldContainer[
        OrderCancellation
    ]
    ...
    update_margin_mode: _containers.RepeatedCompositeFieldContainer[
        UpdateMarginMode
    ]
    def __init__(
        self,
        cancellations: _Optional[
            _Iterable[_Union[OrderCancellation, _Mapping]]
        ] = ...,
        amendments: _Optional[
            _Iterable[_Union[OrderAmendment, _Mapping]]
        ] = ...,
        submissions: _Optional[
            _Iterable[_Union[OrderSubmission, _Mapping]]
        ] = ...,
...
class OrderSubmission(_message.Message):
    ...
    def __init__(
        ...
        time_in_force: _Optional[
            _Union[_vega_pb2.Order.TimeInForce, str]
        ] = ...,
        expires_at: _Optional[int] = ...,
...
class OrderAmendment(_message.Message):
    ...
    def __init__(
        ...
        pegged_reference: _Optional[
            _Union[_vega_pb2.PeggedReference, str]
        ] = ...,
        size: _Optional[int] = ...,
    ) -> None: ...
...
class ProposalSubmission(_message.Message):
    ...
    def __init__(
        ...
        reference: _Optional[str] = ...,
        terms: _Optional[
            _Union[_governance_pb2.ProposalTerms, _Mapping]
        ] = ...,
        rationale: _Optional[
            _Union[_governance_pb2.ProposalRationale, _Mapping]
        ] = ...,
    ) -> None: ...
...
class BatchProposalSubmissionTerms(_message.Message):
    ...
    def __init__(
        ...
        changes: _Optional[
            _Iterable[
                _Union[_governance_pb2.BatchProposalTermsChange, _Mapping]
            ]
        ] = ...,
    ) -> None: ...
...
class DelayedTransactionsWrapper(_message.Message):
    ...
    def __init__(
        self, transactions: _Optional[_Iterable[bytes]] = ...
    ) -> None: ...
