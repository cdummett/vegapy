...
class OrderError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    ORDER_ERROR_CANNOT_SEND_GFA_ORDER_DURING_CONTINUOUS_TRADING: _ClassVar[
        OrderError
    ]
    ...
    ORDER_ERROR_REDUCE_ONLY_ORDER_WOULD_NOT_REDUCE_POSITION: _ClassVar[
        OrderError
    ]
...
class StopOrder(_message.Message):
    ...
    class SizeOverrideSetting(
        int, metaclass=_enum_type_wrapper.EnumTypeWrapper
    ):
        __slots__ = ()
        SIZE_OVERRIDE_SETTING_UNSPECIFIED: _ClassVar[
    ...
    class RejectionReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        REJECTION_REASON_TRADING_NOT_ALLOWED: _ClassVar[
            StopOrder.RejectionReason
        ]
        REJECTION_REASON_EXPIRY_IN_THE_PAST: _ClassVar[
            StopOrder.RejectionReason
        ]
        REJECTION_REASON_MUST_BE_REDUCE_ONLY: _ClassVar[
            StopOrder.RejectionReason
        ]
    ...
    def __init__(
        ...
        expiry_strategy: _Optional[
            _Union[StopOrder.ExpiryStrategy, str]
        ] = ...,
        trigger_direction: _Optional[
            _Union[StopOrder.TriggerDirection, str]
        ] = ...,
        ...
        rejection_reason: _Optional[
            _Union[StopOrder.RejectionReason, str]
        ] = ...,
...
class OrderCancellationConfirmation(_message.Message):
    ...
    order: Order
    def __init__(
        self, order: _Optional[_Union[Order, _Mapping]] = ...
    ) -> None: ...
...
class OrderConfirmation(_message.Message):
    ...
    def __init__(
        ...
        passive_orders_affected: _Optional[
            _Iterable[_Union[Order, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class DispatchStrategy(_message.Message):
    ...
    def __init__(
        ...
        notional_time_weighted_average_position_requirement: _Optional[
            str
        ] = ...,
        window_length: _Optional[int] = ...,
        lock_period: _Optional[int] = ...,
        distribution_strategy: _Optional[
...
class Rank(_message.Message):
    ...
    def __init__(
        self,
        start_rank: _Optional[int] = ...,
        share_ratio: _Optional[int] = ...,
    ) -> None: ...
...
class LedgerMovement(_message.Message):
    ...
    def __init__(
        ...
        balances: _Optional[
            _Iterable[_Union[PostTransferBalance, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class MarketData(_message.Message):
    ...
    def __init__(
        ...
        mark_price_type: _Optional[
            _Union[_markets_pb2.CompositePriceType, str]
        ] = ...,
        mark_price_state: _Optional[
            _Union[CompositePriceState, _Mapping]
        ] = ...,
    ) -> None: ...
...
class CompositePriceState(_message.Message):
    ...
    price_sources: _containers.RepeatedCompositeFieldContainer[
...
class LiquidityProviderSLA(_message.Message):
    ...
    hysteresis_period_fee_penalties: _containers.RepeatedScalarFieldContainer[
        str
    ]
...
class LiquidityProvision(_message.Message):
    ...
    def __init__(
        ...
        fee: _Optional[str] = ...,
        sells: _Optional[
            _Iterable[_Union[LiquidityOrderReference, _Mapping]]
        ] = ...,
        buys: _Optional[
            _Iterable[_Union[LiquidityOrderReference, _Mapping]]
        ] = ...,
...
class EthereumL2Configs(_message.Message):
    ...
    def __init__(
        self,
        configs: _Optional[
            _Iterable[_Union[EthereumL2Config, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class ReferralProgram(_message.Message):
    ...
    def __init__(
        ...
        benefit_tiers: _Optional[
            _Iterable[_Union[BenefitTier, _Mapping]]
        ] = ...,
        end_of_program_timestamp: _Optional[int] = ...,
        window_length: _Optional[int] = ...,
        staking_tiers: _Optional[
            _Iterable[_Union[StakingTier, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class VestingBenefitTiers(_message.Message):
    ...
    def __init__(
        self,
        tiers: _Optional[
            _Iterable[_Union[VestingBenefitTier, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class VolumeDiscountProgram(_message.Message):
    ...
    def __init__(
        ...
        id: _Optional[str] = ...,
        benefit_tiers: _Optional[
            _Iterable[_Union[VolumeBenefitTier, _Mapping]]
        ] = ...,
        end_of_program_timestamp: _Optional[int] = ...,
        window_length: _Optional[int] = ...,
    ) -> None: ...
...
class ActivityStreakBenefitTiers(_message.Message):
    ...
    def __init__(
        self,
        tiers: _Optional[
            _Iterable[_Union[ActivityStreakBenefitTier, _Mapping]]
        ] = ...,
    ) -> None: ...

class ActivityStreakBenefitTier(_message.Message):
    __slots__ = (
        "minimum_activity_streak",
        "reward_multiplier",
        "vesting_multiplier",
    )
