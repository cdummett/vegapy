...
class AssetEntry(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        asset_details: _Optional[
            _Union[_assets_pb2.AssetDetails, _Mapping]
        ] = ...,
    ) -> None: ...
...
class Assets(_message.Message):
    ...
    pending_listing_assets: _containers.RepeatedCompositeFieldContainer[
        AssetEntry
    ]
    def __init__(
        self,
...
class Collateral(_message.Message):
    ...
    def __init__(
        self,
        balances: _Optional[_Iterable[_Union[AssetBalance, _Mapping]]] = ...,
    ) -> None: ...
...
class Rewards(_message.Message):
    ...
    def __init__(
        self,
        rewards: _Optional[_Iterable[_Union[RewardPayout, _Mapping]]] = ...,
    ) -> None: ...
...
class RewardPayout(_message.Message):
    ...
    payout_time: int
    rewards_payout: _containers.RepeatedCompositeFieldContainer[
        PendingRewardPayout
    ]
    def __init__(
        self,
...
class ScheduledTransfer(_message.Message):
    ...
    def __init__(
        ...
        oneoff_transfer: _Optional[
            _Union[_events_pb2.Transfer, _Mapping]
        ] = ...,
    ) -> None: ...
...
class ScheduledTransferAtTime(_message.Message):
    ...
    def __init__(
        ...
        transfers: _Optional[
            _Iterable[_Union[ScheduledTransfer, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Banking(_message.Message):
    ...
    def __init__(
        ...
        recurring_transfers: _Optional[
            _Union[RecurringTransfers, _Mapping]
        ] = ...,
        primary_bridge_state: _Optional[_Union[BridgeState, _Mapping]] = ...,
        asset_actions: _Optional[
            _Iterable[_Union[AssetAction, _Mapping]]
        ] = ...,
...
class Validators(_message.Message):
    ...
    validator_state: _containers.RepeatedCompositeFieldContainer[
        ValidatorState
    ]
...
class Staking(_message.Message):
    ...
    accepted: _containers.RepeatedCompositeFieldContainer[
...
class MarketActivityTracker(_message.Message):
    ...
    time_weighted_position: _containers.RepeatedCompositeFieldContainer[
        TWPositionData
    ]
    time_weighted_notional: _containers.RepeatedCompositeFieldContainer[
        TWNotionalData
    ]
    ...
    maker_fees_paid_history: _containers.RepeatedCompositeFieldContainer[
        EpochPartyFees
    ]
    ...
    def __init__(
        ...
        asset: _Optional[str] = ...,
        maker_fees_received: _Optional[
            _Iterable[_Union[PartyFees, _Mapping]]
        ] = ...,
        ...
        returns_data: _Optional[
            _Iterable[_Union[ReturnsData, _Mapping]]
        ] = ...,
...
class AssetMarketPartyTakerFees(_message.Message):
    ...
    def __init__(
        ...
        asset: _Optional[str] = ...,
        market: _Optional[str] = ...,
        taker_fees: _Optional[
            _Iterable[_Union[PartyTakerFees, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class EpochPartyFees(_message.Message):
    ...
    def __init__(
        self,
        party_fees: _Optional[
            _Iterable[_Union[PartyFeesHistory, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class EpochReturnsData(_message.Message):
    ...
    def __init__(
        self,
        returns: _Optional[_Iterable[_Union[ReturnsData, _Mapping]]] = ...,
    ) -> None: ...
...
class AssetAction(_message.Message):
    ...
    def __init__(
        ...
        asset_list: _Optional[
            _Union[_chain_events_pb2.ERC20AssetList, _Mapping]
        ] = ...,
