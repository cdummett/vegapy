...
class LogNormalRiskModel(_message.Message):
    ...
    def __init__(
        ...
        risk_factor_override: _Optional[
            _Union[RiskFactorOverride, _Mapping]
        ] = ...,
    ) -> None: ...
...
class TradableInstrument(_message.Message):
    ...
    def __init__(
        ...
        log_normal_risk_model: _Optional[
            _Union[LogNormalRiskModel, _Mapping]
        ] = ...,
...
class Fees(_message.Message):
    ...
    def __init__(
        ...
        liquidity_fee_settings: _Optional[
            _Union[LiquidityFeeSettings, _Mapping]
        ] = ...,
    ) -> None: ...
...
class PriceMonitoringParameters(_message.Message):
    ...
    triggers: _containers.RepeatedCompositeFieldContainer[
        PriceMonitoringTrigger
    ]
    def __init__(
        self,
        triggers: _Optional[
            _Iterable[_Union[PriceMonitoringTrigger, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class PriceMonitoringSettings(_message.Message):
    ...
    def __init__(
        ...
        parameters: _Optional[
            _Union[PriceMonitoringParameters, _Mapping]
        ] = ...,
    ) -> None: ...
...
class TargetStakeParameters(_message.Message):
    ...
    def __init__(
        self,
        time_window: _Optional[int] = ...,
        scaling_factor: _Optional[float] = ...,
    ) -> None: ...
...
class Market(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        tradable_instrument: _Optional[
            _Union[TradableInstrument, _Mapping]
        ] = ...,
        ...
        liquidity_sla_params: _Optional[
            _Union[LiquiditySLAParameters, _Mapping]
        ] = ...,
        liquidation_strategy: _Optional[
            _Union[LiquidationStrategy, _Mapping]
        ] = ...,
