...
class ProposalError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PROPOSAL_ERROR_NETWORK_PARAMETER_VALIDATION_FAILED: _ClassVar[
        ProposalError
    ]
    ...
    PROPOSAL_ERROR_PARTICIPATION_THRESHOLD_NOT_REACHED: _ClassVar[
        ProposalError
    ]
    ...
    PROPOSAL_ERROR_LINEAR_SLIPPAGE_FACTOR_OUT_OF_RANGE: _ClassVar[
        ProposalError
    ]
    PROPOSAL_ERROR_QUADRATIC_SLIPPAGE_FACTOR_OUT_OF_RANGE: _ClassVar[
        ProposalError
    ]
    ...
    PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_FAILED: _ClassVar[
        ProposalError
    ]
    PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_INVALID: _ClassVar[
        ProposalError
    ]
    PROPOSAL_ERROR_GOVERNANCE_CANCEL_TRANSFER_PROPOSAL_INVALID: _ClassVar[
        ProposalError
    ]
...
class NewSpotMarketConfiguration(_message.Message):
    ...
    def __init__(
        ...
        simple: _Optional[
            _Union[_markets_pb2.SimpleModelParams, _Mapping]
        ] = ...,
        log_normal: _Optional[
            _Union[_markets_pb2.LogNormalRiskModel, _Mapping]
        ] = ...,
...
class NewSpotMarket(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[NewSpotMarketConfiguration, _Mapping]] = ...,
    ) -> None: ...
...
class NewMarket(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[NewMarketConfiguration, _Mapping]] = ...,
    ) -> None: ...
...
class UpdateSpotMarket(_message.Message):
    ...
    def __init__(
        ...
        market_id: _Optional[str] = ...,
        changes: _Optional[
            _Union[UpdateSpotMarketConfiguration, _Mapping]
        ] = ...,
    ) -> None: ...
...
class UpdateMarketConfiguration(_message.Message):
    ...
    def __init__(
        ...
        instrument: _Optional[
            _Union[UpdateInstrumentConfiguration, _Mapping]
        ] = ...,
        metadata: _Optional[_Iterable[str]] = ...,
        price_monitoring_parameters: _Optional[
            _Union[_markets_pb2.PriceMonitoringParameters, _Mapping]
...
class UpdateNetworkParameter(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[_vega_pb2.NetworkParameter, _Mapping]] = ...,
    ) -> None: ...
...
class NewAsset(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[_assets_pb2.AssetDetails, _Mapping]] = ...,
    ) -> None: ...
...
class UpdateAsset(_message.Message):
    ...
    def __init__(
        ...
        changes: _Optional[
            _Union[_assets_pb2.AssetDetailsUpdate, _Mapping]
        ] = ...,
    ) -> None: ...
...
class ProposalTerms(_message.Message):
    ...
    def __init__(
        ...
        update_spot_market: _Optional[
            _Union[UpdateSpotMarket, _Mapping]
        ] = ...,
        new_transfer: _Optional[_Union[NewTransfer, _Mapping]] = ...,
        cancel_transfer: _Optional[_Union[CancelTransfer, _Mapping]] = ...,
        update_market_state: _Optional[
            _Union[UpdateMarketState, _Mapping]
        ] = ...,
...
class BatchProposalTerms(_message.Message):
    ...
    def __init__(
        ...
        changes: _Optional[
            _Iterable[_Union[BatchProposalTermsChange, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Vote(_message.Message):
    ...
    def __init__(
        ...
        els_per_market: _Optional[
            _Iterable[_Union[VoteELSPair, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class UpdateVolumeDiscountProgram(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[
            _Union[VolumeDiscountProgramChanges, _Mapping]
        ] = ...,
    ) -> None: ...
...
class UpdateReferralProgram(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[ReferralProgramChanges, _Mapping]] = ...,
    ) -> None: ...
...
class UpdateMarketState(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[
            _Union[UpdateMarketStateConfiguration, _Mapping]
        ] = ...,
    ) -> None: ...
...
class CancelTransfer(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[
            _Union[CancelTransferConfiguration, _Mapping]
        ] = ...,
    ) -> None: ...
...
class NewTransfer(_message.Message):
    ...
    def __init__(
        self,
        changes: _Optional[_Union[NewTransferConfiguration, _Mapping]] = ...,
    ) -> None: ...
