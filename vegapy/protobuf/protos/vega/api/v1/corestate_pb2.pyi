...
class ListNetworkParametersRequest(_message.Message):
    ...
    def __init__(
        self, network_parameter_key: _Optional[str] = ...
    ) -> None: ...
...
class ListValidatorsResponse(_message.Message):
    ...
    validators: _containers.RepeatedCompositeFieldContainer[
        _events_pb2.ValidatorUpdate
    ]
    def __init__(
        self,
...
class ListPartiesStakeResponse(_message.Message):
    ...
    def __init__(
        self,
        parties_stake: _Optional[
            _Iterable[_Union[PartyStake, _Mapping]]
        ] = ...,
    ) -> None: ...
