...
class Payload(_message.Message):
    ...
    def __init__(
        ...
        simple_spam_policy: _Optional[
            _Union[SimpleSpamPolicy, _Mapping]
        ] = ...,
        ...
        stake_verifier_removed: _Optional[
            _Union[StakeVerifierRemoved, _Mapping]
        ] = ...,
        ...
        liquidity_parameters: _Optional[
            _Union[LiquidityParameters, _Mapping]
        ] = ...,
        ...
        liquidity_provisions: _Optional[
            _Union[LiquidityProvisions, _Mapping]
        ] = ...,
        liquidity_supplied: _Optional[
            _Union[LiquiditySupplied, _Mapping]
        ] = ...,
        ...
        pending_asset_updates: _Optional[
            _Union[PendingAssetUpdates, _Mapping]
        ] = ...,
        ...
        spot_liquidity_target: _Optional[
            _Union[SpotLiquidityTarget, _Mapping]
        ] = ...,
        ...
        liquidity_v2_supplied: _Optional[
            _Union[LiquidityV2Supplied, _Mapping]
        ] = ...,
        liquidity_v2_scores: _Optional[
            _Union[LiquidityV2Scores, _Mapping]
        ] = ...,
        ...
        referral_program: _Optional[
            _Union[ReferralProgramData, _Mapping]
        ] = ...,
...
class HoldingAccountTracker(_message.Message):
    ...
    market_id: str
    order_holding: _containers.RepeatedCompositeFieldContainer[
        OrderHoldingQuantities
    ]
    def __init__(
        self,
...
class LiquidityTarget(_message.Message):
    ...
    def __init__(
        ...
        max_open_interests: _Optional[
            _Union[TimestampedOpenInterest, _Mapping]
        ] = ...,
    ) -> None: ...
...
class SpotLiquidityTarget(_message.Message):
    ...
    def __init__(
        ...
        max_total_stake: _Optional[
            _Union[TimestampedTotalStake, _Mapping]
        ] = ...,
    ) -> None: ...
...
class OracleDataBatch(_message.Message):
    ...
    def __init__(
        self,
        oracle_data: _Optional[_Iterable[_Union[OracleData, _Mapping]]] = ...,
    ) -> None: ...
...
class OracleData(_message.Message):
    ...
    def __init__(
        self,
        signers: _Optional[
            _Iterable[_Union[_data_pb2.Signer, _Mapping]]
        ] = ...,
        data: _Optional[_Iterable[_Union[OracleDataPair, _Mapping]]] = ...,
        meta_data: _Optional[
            _Iterable[_Union[_data_pb2.Property, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class BankingWithdrawals(_message.Message):
    ...
    def __init__(
        self,
        withdrawals: _Optional[_Iterable[_Union[Withdrawal, _Mapping]]] = ...,
    ) -> None: ...
...
class BankingScheduledTransfers(_message.Message):
    ...
    def __init__(
        ...
        transfers_at_time: _Optional[
            _Iterable[
                _Union[_checkpoint_pb2.ScheduledTransferAtTime, _Mapping]
            ]
        ] = ...,
    ) -> None: ...
...
class BankingScheduledGovernanceTransfers(_message.Message):
    ...
    def __init__(
        ...
        transfers_at_time: _Optional[
            _Iterable[
                _Union[
                    _checkpoint_pb2.ScheduledGovernanceTransferAtTime, _Mapping
                ]
            ]
        ] = ...,
    ) -> None: ...
...
class BankingBridgeState(_message.Message):
    ...
    def __init__(
        self,
        bridge_state: _Optional[
            _Union[_checkpoint_pb2.BridgeState, _Mapping]
        ] = ...,
    ) -> None: ...
...
class DelegationLastReconciliationTime(_message.Message):
    ...
    def __init__(
        self, last_reconciliation_time: _Optional[int] = ...
    ) -> None: ...
...
class DelegationPending(_message.Message):
    ...
    undelegation: _containers.RepeatedCompositeFieldContainer[
        _vega_pb2.Delegation
    ]
    def __init__(
        self,
...
class GovernanceEnacted(_message.Message):
    ...
    def __init__(
        self,
        proposals: _Optional[_Iterable[_Union[ProposalData, _Mapping]]] = ...,
    ) -> None: ...
...
class GovernanceBatchActive(_message.Message):
    ...
    batch_proposals: _containers.RepeatedCompositeFieldContainer[
        BatchProposalData
    ]
    def __init__(
        self,
...
class NetParams(_message.Message):
    ...
    params: _containers.RepeatedCompositeFieldContainer[
...
class PastPrice(_message.Message):
    ...
    def __init__(
        self,
        time: _Optional[int] = ...,
        volume_weighted_price: _Optional[str] = ...,
    ) -> None: ...
...
class PriceMonitor(_message.Message):
    ...
    price_range_cache: _containers.RepeatedCompositeFieldContainer[
        PriceRangeCache
    ]
    ...
    def __init__(
        ...
        ref_price_cache: _Optional[
            _Iterable[_Union[DecimalMap, _Mapping]]
        ] = ...,
...
class SpotMarket(_message.Message):
    ...
    expiring_orders: _containers.RepeatedCompositeFieldContainer[
        _vega_pb2.Order
    ]
    last_best_bid: str
    last_best_ask: str
    ...
    expiring_stop_orders: _containers.RepeatedCompositeFieldContainer[
        _vega_pb2.Order
    ]
...
class Market(_message.Message):
    ...
    product: Product
    fees_stats: _events_pb2.FeesStats
    party_margin_factor: _containers.RepeatedCompositeFieldContainer[
        PartyMarginFactor
    ]
...
class AmmState(_message.Message):
    ...
    def __init__(
        ...
        amm_party_ids: _Optional[
            _Iterable[_Union[StringMapEntry, _Mapping]]
        ] = ...,
    ...
    class Pool(_message.Message):
        ...
        def __init__(
            ...
            parameters: _Optional[
                _Union[
                    _events_pb2.AMM.ConcentratedLiquidityParameters, _Mapping
                ]
            ] = ...,
            asset: _Optional[str] = ...,
...
class Product(_message.Message):
    ...
    perps: Perps
    def __init__(
        self, perps: _Optional[_Union[Perps, _Mapping]] = ...
    ) -> None: ...
...
class Perps(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        external_data_point: _Optional[
            _Iterable[_Union[DataPoint, _Mapping]]
        ] = ...,
        internal_data_point: _Optional[
            _Iterable[_Union[DataPoint, _Mapping]]
        ] = ...,
        seq: _Optional[int] = ...,
...
class OrdersAtPrice(_message.Message):
    ...
    def __init__(
        self,
        price: _Optional[str] = ...,
        orders: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class PricedStopOrders(_message.Message):
    ...
    def __init__(
        self,
        falls_bellow: _Optional[
            _Iterable[_Union[OrdersAtPrice, _Mapping]]
        ] = ...,
        rises_above: _Optional[
            _Iterable[_Union[OrdersAtPrice, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class TrailingStopOrders(_message.Message):
    ...
    def __init__(
        ...
        falls_bellow: _Optional[
            _Iterable[_Union[OffsetsAtPrice, _Mapping]]
        ] = ...,
        rises_above: _Optional[
            _Iterable[_Union[OffsetsAtPrice, _Mapping]]
        ] = ...,
...
class StopOrders(_message.Message):
    ...
    stop_orders: _containers.RepeatedCompositeFieldContainer[
        _events_pb2.StopOrderEvent
    ]
    ...
    def __init__(
        ...
        priced_stop_orders: _Optional[
            _Union[PricedStopOrders, _Mapping]
        ] = ...,
        trailing_stop_orders: _Optional[
            _Union[TrailingStopOrders, _Mapping]
        ] = ...,
    ) -> None: ...
...
class ExecutionMarkets(_message.Message):
    ...
    def __init__(
        ...
        sla_network_params: _Optional[
            _Union[SLANetworkParams, _Mapping]
        ] = ...,
    ) -> None: ...
...
class MarketPositions(_message.Message):
    ...
    parties_records: _containers.RepeatedCompositeFieldContainer[
        PartyPositionStats
    ]
    def __init__(
        self,
...
class LastSettledPosition(_message.Message):
    ...
    def __init__(
        self,
        party: _Optional[str] = ...,
        settled_position: _Optional[int] = ...,
    ) -> None: ...
...
class ScheduledRewardsPayout(_message.Message):
    ...
    def __init__(
        ...
        rewards_payout: _Optional[
            _Iterable[_Union[RewardsPayout, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class RewardsPayout(_message.Message):
    ...
    from_account: str
    asset: str
    reward_party_amount: _containers.RepeatedCompositeFieldContainer[
        RewardsPartyAmount
    ]
    total_reward: str
    epoch_seq: str
...
class VoteSpamPolicy(_message.Message):
    ...
    party_to_vote: _containers.RepeatedCompositeFieldContainer[
        PartyProposalVoteCount
    ]
    banned_parties: _containers.RepeatedCompositeFieldContainer[BannedParty]
    token_balance: _containers.RepeatedCompositeFieldContainer[
        PartyTokenBalance
    ]
    ...
    def __init__(
        ...
        banned_parties: _Optional[
            _Iterable[_Union[BannedParty, _Mapping]]
        ] = ...,
        token_balance: _Optional[
            _Iterable[_Union[PartyTokenBalance, _Mapping]]
        ] = ...,
...
class Notary(_message.Message):
    ...
    def __init__(
        self,
        notary_sigs: _Optional[_Iterable[_Union[NotarySigs, _Mapping]]] = ...,
    ) -> None: ...

class StakeVerifierDeposited(_message.Message):
    __slots__ = ("pending_deposited",)
    PENDING_DEPOSITED_FIELD_NUMBER: _ClassVar[int]
    pending_deposited: _containers.RepeatedCompositeFieldContainer[
...
class StakeVerifierRemoved(_message.Message):
    ...
    pending_removed: _containers.RepeatedCompositeFieldContainer[
        StakeVerifierPending
    ]
    def __init__(
        self,
...
class L2EthOracles(_message.Message):
    ...
    chain_id_eth_oracles: _containers.RepeatedCompositeFieldContainer[
        ChainIdEthOracles
    ]
    def __init__(
        self,
...
class ValidatorState(_message.Message):
    ...
    def __init__(
        ...
        ranking_score: _Optional[
            _Union[_vega_pb2.RankingScore, _Mapping]
        ] = ...,
    ) -> None: ...
...
class ValidatorPerformance(_message.Message):
    ...
    validator_perf_stats: _containers.RepeatedCompositeFieldContainer[
        PerformanceStats
    ]
    def __init__(
        self,
...
class LiquidityPartiesLiquidityOrders(_message.Message):
    ...
    def __init__(
        self,
        party_orders: _Optional[
            _Iterable[_Union[PartyOrders, _Mapping]]
        ] = ...,
        market_id: _Optional[str] = ...,
    ) -> None: ...
...
class LiquidityV2PerformancePerParty(_message.Message):
    ...
    registered_penalties_per_epoch: _containers.RepeatedScalarFieldContainer[
        str
    ]
...
class FloatingPointConsensus(_message.Message):
    ...
    next_time_trigger: _containers.RepeatedCompositeFieldContainer[
        NextTimeTrigger
    ]
    state_variables: _containers.RepeatedCompositeFieldContainer[
...
class FloatingPointValidatorResult(_message.Message):
    ...
    id: str
    bundle: _containers.RepeatedCompositeFieldContainer[
        _vega_pb2.KeyValueBundle
    ]
    def __init__(
        self,
        id: _Optional[str] = ...,
        bundle: _Optional[
            _Iterable[_Union[_vega_pb2.KeyValueBundle, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class ProofOfWork(_message.Message):
    ...
    tx_at_height: _containers.RepeatedCompositeFieldContainer[
        TransactionsAtHeight
    ]
    tid_at_height: _containers.RepeatedCompositeFieldContainer[
        TransactionsAtHeight
    ]
    ...
    nonce_refs_at_height: _containers.RepeatedCompositeFieldContainer[
        NonceRefsAtHeight
    ]
    def __init__(
        self,
        ...
        pow_params: _Optional[
            _Iterable[_Union[ProofOfWorkParams, _Mapping]]
        ] = ...,
        pow_state: _Optional[
            _Iterable[_Union[ProofOfWorkState, _Mapping]]
        ] = ...,
...
class ProofOfWorkState(_message.Message):
    __slots__ = ("pow_state",)
    POW_STATE_FIELD_NUMBER: _ClassVar[int]
    pow_state: _containers.RepeatedCompositeFieldContainer[
        ProofOfWorkBlockState
    ]
    def __init__(
        self,
        pow_state: _Optional[
            _Iterable[_Union[ProofOfWorkBlockState, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class TeamSwitches(_message.Message):
    ...
    def __init__(
        self,
        team_switches: _Optional[
            _Iterable[_Union[TeamSwitch, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Vesting(_message.Message):
    ...
    def __init__(
        self,
        parties_reward: _Optional[
            _Iterable[_Union[PartyReward, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class PartyReward(_message.Message):
    ...
    def __init__(
        self,
        party: _Optional[str] = ...,
        asset_locked: _Optional[
            _Iterable[_Union[AssetLocked, _Mapping]]
        ] = ...,
...
class ReferralProgramData(_message.Message):
    ...
    factor_by_referee: _containers.RepeatedCompositeFieldContainer[
        FactorByReferee
    ]
    ...
    def __init__(
        ...
        current_program: _Optional[
            _Union[_vega_pb2.ReferralProgram, _Mapping]
        ] = ...,
        new_program: _Optional[
            _Union[_vega_pb2.ReferralProgram, _Mapping]
        ] = ...,
...
class ReferralSet(_message.Message):
    ...
    def __init__(
        ...
        referrer: _Optional[_Union[Membership, _Mapping]] = ...,
        referees: _Optional[_Iterable[_Union[Membership, _Mapping]]] = ...,
        running_volumes: _Optional[
            _Iterable[_Union[RunningVolume, _Mapping]]
        ] = ...,
...
class AssetLocked(_message.Message):
    ...
    def __init__(
        self,
        asset: _Optional[str] = ...,
        epoch_balances: _Optional[
            _Iterable[_Union[EpochBalance, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class VolumeDiscountProgram(_message.Message):
    ...
    PROGRAM_HAS_ENDED_FIELD_NUMBER: _ClassVar[int]
    parties: _containers.RepeatedScalarFieldContainer[str]
    epoch_party_volumes: _containers.RepeatedCompositeFieldContainer[
        EpochPartyVolumes
    ]
    epoch_data_index: int
    average_party_volume: _containers.RepeatedCompositeFieldContainer[
        PartyVolume
    ]
    current_program: _vega_pb2.VolumeDiscountProgram
    new_program: _vega_pb2.VolumeDiscountProgram
    factors_by_party: _containers.RepeatedCompositeFieldContainer[
        VolumeDiscountStats
    ]
    last_program_version: int
    program_has_ended: bool
    def __init__(
        ...
        average_party_volume: _Optional[
            _Iterable[_Union[PartyVolume, _Mapping]]
        ] = ...,
        current_program: _Optional[
...
class BankingTransferFeeDiscounts(_message.Message):
    ...
    party_asset_discount: _containers.RepeatedCompositeFieldContainer[
        PartyAssetAmount
    ]
    def __init__(
        self,
...
class CompositePriceCalculator(_message.Message):
    ...
    def __init__(
        ...
        book_price_at_time: _Optional[
            _Iterable[_Union[TimePrice, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Parties(_message.Message):
    ...
    def __init__(
        self,
        profiles: _Optional[_Iterable[_Union[PartyProfile, _Mapping]]] = ...,
    ) -> None: ...
...
class PartyProfile(_message.Message):
    ...
    def __init__(
        ...
        alias: _Optional[str] = ...,
        metadata: _Optional[
            _Iterable[_Union[_vega_pb2.Metadata, _Mapping]]
        ] = ...,
